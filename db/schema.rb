...
ActiveRecord::Schema.define(version: 2018_06_28_104321) do
  ...
  create_table "orders", force: :cascade do |t|
    ...
    t.string "name"
    t.string "total"
    t.index ["client_order_id"], name: "index_orders_on_client_order_id"
  end
  ...
  add_foreign_key "orders", "client_orders"
